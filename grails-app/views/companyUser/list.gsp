...
<html>
	...
	<body>
		<a href="#list-companyUser" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
			...
			<table>
				<thead>
					<tr>
						...
						<th><g:message code="companyUser.bumen.label" default="Bumen" /></th>
				...
				<g:each in="${companyUserInstanceList}" status="i" var="companyUserInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${companyUserInstance.id}">${fieldValue(bean: companyUserInstance, field: "bumen")}</g:link></td>
